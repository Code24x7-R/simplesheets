...
describe('ProjectView', () => {
  ...
  it('renders project view', () => {
    render(<ProjectView project={project} activeSheet={mockSheet} onSaveProject={jest.fn()} onClose={jest.fn()} />);
  ...
  it('calls onClose when Close is clicked', () => {
    ...
    render(<ProjectView project={project} activeSheet={mockSheet} onSaveProject={jest.fn()} onClose={onClose} />);
